...
var CFG = {
    ...
    forensischePatronen: [
        ...
        { p: /ChipSoft\.PlatformServices/i,              l: 'KRITIEK ChipSoft HiX API blootgesteld (NB-177)' },
        { p: /GetCurrentPatientAndUserObject/i,          l: 'KRITIEK ChipSoft patientobject gelekt (NB-177)' },
        { p: /2001702222/,                               l: 'KRITIEK ChipSoft patient-ID Grothe (NB-177)' },
        { p: /DYN_CURRENT_USER/i,                        l: 'ChipSoft HiX sessie token (NB-177)' },
        { p: /PATIENT_PATIENT/i,                         l: 'ChipSoft HiX patientklasse (NB-177)' },
        { p: /account_id\s*[:=]\s*763232/i,             l: 'KRITIEK VWO tracker account_id=763232 (NB-53)' },
        { p: /hide_element.*opacity.*0|body.*opacity.*0.*important/i, l: 'KRITIEK VWO body opacity:0 aanval (NB-53)' },
        { p: /vwo_uuid/i,                                l: 'VWO UUID tracking na weigering (NB-178)' },
        { p: /datadog.*browser-intake|browser-intake.*datadoghq/i, l: 'Datadog RUM telemetrie (NB-69)' },
        { p: /WoundListSection/i,                        l: 'CSS WoundListSection aanwezig (NB-12)' },
        { p: /GetPatientDocuments/i,                     l: 'ChipSoft GetPatientDocuments (NB-177)' },
        { p: /GetPathologyResults/i,                     l: 'ChipSoft GetPathologyResults (NB-177)' },
        { p: /GetDcrRegistrations/i,                     l: 'ChipSoft GetDcrRegistrations toestemmingen (NB-177)' },
        { p: /DigiDClusterHybrid/i,                      l: 'ChipSoft DigiD authenticatie flow (NB-177)' },
        { p: /centramed\.nl/i,                           l: 'Centramed aansprakelijkheidsverzekeraar (NB-179)' },
    ],
};
